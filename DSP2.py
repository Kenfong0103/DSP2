...
st.markdown("""
    <div style="width:100%; overflow-x:auto;">
        ...
        <p style="text-align: left; font-size: 15px;">2) Or use the following link to download the provided images.</p><a href="https://drive.google.com/drive/folders/12FwxUc8npY8galvBo3pZzQqI_3BPdf69?usp=sharing" target="_blank">Download images</a>
